...
CLIENT="$HOME/.gradle/caches/com.palantir.graal/20.2.0/8/graalvm-ce-java8-20.2.0/Contents/Home/bin/java -agentlib:native-image-agent=config-output-dir=src/main/resources/META-INF/native-image -jar build/libs/client-1.0-SNAPSHOT-all.jar"
