...
/**
 * This class forwards the datasets from clients to enclave for training/testing the model. This class is also
 * responsible for sending the model evaluation results back to all the clients.
 */
public class Host {
    ...
    public static void main(String args[]) throws EnclaveLoadException, IOException {
        final String enclaveClassName = "com.r3.conclave.sample.enclave.MlEnclave";
