...
a string to the enclave, the enclave will reverse it and send it back to the client.

#Step 1: Prerequisites
You need [JDK](https://www.openlogic.com/openjdk-downloads) 8 or 11 installed in order to build and run the app.<br />
...
Copy paste the below code to receiveMail method in SimpleEnclave class. This logic reverses the string received by the client and sends it back to the client.
